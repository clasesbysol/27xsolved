...
self.addEventListener('fetch',event=>{
  ...
  // An in-flight response from the retiring worker can recreate its old cache.
  // Sweep again on subsequent requests, without touching other apps or user data.
